    ...
    if (index >= 0 && index <= 9) {
      if (index === 0 || index === 1 || index === 2) {
        ...
        sections.push(
          ...
          <div style={{ width: "95%", height: "8%", borderRadius: "50px", backgroundImage: `linear-gradient(to left, rgba(255, 255, 153, 0.5), rgba(220, 50, 5, 0.7))`, display: 'flex', alignItems: 'center', marginBottom: "0.5%", border: "2px solid white" }}>
