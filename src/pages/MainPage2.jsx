...
export default function MainPage1() {
    ...
    const getGradientColors = (index) => {
        ...
        const gradientColors = [
            `linear-gradient(to left, rgba(240, 160, 0, 0.9), rgba(170, 10, 5, 0.8))`,
            `linear-gradient(to left, rgba(240, 160, 0, 0.8), rgba(160, 10, 5, 0.8))`,
            `linear-gradient(to left, rgba(240, 160, 0, 0.7), rgba(150, 10, 5, 0.8))`,
       ...
       // Helper function to get gradient colors based on index
       const getGradientColors2 = (index) => {
        // Define your gradient colors logic here
        const gradientColors = [           
            `linear-gradient(to left, rgba(240, 160, 0, 0.6), rgba(241, 108, 5, 0.6))`,
        ];
    ...
    const sections1 = competitors.slice(0, 10).map((competitor, index) => {
        ...
        const divStyle = {
            ...
            alignItems: 'center',
            marginBottom: "0.6%",
            border: competitor.ready ? "8px ridge white" : "2px solid white",  // "ready" true ise kırmızı, değilse beyaz kenarlık
            ...
            <div key={competitor.id} style={divStyle}>
                ...
                <div style={{ flex: "0.2" }}>
                    ...
                    <div style={{ width: "200%", height: "200%", borderRadius: "50%" }}>
                        ...
                        {index < 3 && (
                            <img src={`${process.env.PUBLIC_URL}/${medalIcon}`} alt={`Icon ${index + 1}`} width="200%" height="100%" style={{ alignSelf: 'flex-start', marginLeft: '-35px' }} />
                        )}

                        {index !== 0 && index !== 1 && index !== 2 && (

                            <img src={`${process.env.PUBLIC_URL}/${index + 1}.png`} alt={`Icon ${index}`} width="230%" height="100%" style={{ alignSelf: 'flex-start', marginLeft: '-35px' }} />
                ...
                {/* yarısmacı bilgileri*/}
                <div style={{ marginLeft: "5%", flex: "4.5", fontWeight: 'bold', fontSize: "200%", color: "white", fontStyle: 'italic', fontFamily: 'New Times Roman', textAlign: 'left' }}>{competitor.city.toUpperCase()} / {competitor.name.toUpperCase()}</div>
                <div style={{ flex: "1", fontWeight: 'bold', fontSize: "220%", color: "white", fontStyle: 'italic', fontFamily: 'New Times Roman' }}> {competitor.eliminated ? <img src={`${process.env.PUBLIC_URL}/eliminated.png`} alt="Icon" width="50%" height="50%" /> : competitor.duration}</div>

                <div style={{ flex: "0.7", display: 'flex', flexDirection: 'row', justifyContent: 'center', width: "60%", height: "60%" }}>

                    <div onClick={() => handleIconUpdateClick(competitor.id)} style={{ cursor: 'pointer' }}>
                        <img src={`${process.env.PUBLIC_URL}/updateIcon.png`} alt="Icon update" width="100%" height="100%" />
                    </div>
                    <div onClick={() => handleIconDeleteClick(competitor.id)} style={{ cursor: 'pointer' }}>
    ...
    const sections2 = competitors.slice(10, 20).map((competitor, index) => {

        const adjustedIndex = index + 10;

        // index numarasına göre div boya koyudan açık renge doğru
        const gradientColors = getGradientColors2(adjustedIndex);


        // index numarasına göre div boya sarı koyudan açık renge doğru
        const gradientColorsReady = getGradientReady(adjustedIndex);


        // index numarasına göre div boya yeşil koyudan açık renge doğru
        const gradientColorsStart = getGradientStart(adjustedIndex);
            ...
            <div key={competitor.id} style={divStyle}>
                ...
                <div style={{ flex: "0.2" }}>
                    ...
                    <div style={{ width: "200%", height: "200%", borderRadius: "50%" }}>
                        ...
                        {adjustedIndex !== 0 && adjustedIndex !== 1 && adjustedIndex !== 2 && (

                            <img src={`${process.env.PUBLIC_URL}/${adjustedIndex + 1}.png`} alt={`Icon ${adjustedIndex}`} width="220%" height="100%" style={{ alignSelf: 'flex-start', marginLeft: '-35px' }} />
                ...
                {/* yarısmacı bilgileri*/}
                <div style={{ marginLeft: "5%", flex: "4", fontWeight: 'bold', fontSize: "200%", color: "white", fontStyle: 'italic', fontFamily: 'New Times Roman', textAlign: 'left' }}>{competitor.city.toUpperCase()} / {competitor.name.toUpperCase()}</div>
                <div style={{ flex: "1", fontWeight: 'bold', fontSize: "220%", color: "white", fontStyle: 'italic', fontFamily: 'New Times Roman' }}>

                    {competitor.eliminated ? <img src={`${process.env.PUBLIC_URL}/eliminated.png`} alt="Icon" width="50%" height="50%" /> : competitor.duration}
    ...
    return (
        <div style={{
            ...
            <div style={{ width: "95%", height: "88%", display: 'flex', marginTop: "6%", justifyContent: "space-between" }}>
